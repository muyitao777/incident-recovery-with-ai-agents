import { Bell, ChevronRight, Clock, Users, Activity, ExternalLink, Sparkles, X, Server, Brain, Search, Lightbulb, CheckCircle, Database, FileText, GitBranch, AlertTriangle, Zap } from 'lucide-react';
...
export default function App() {
  const [activeTab, setActiveTab] = useState<'overview' | 'investigate'>('overview');
  ...
  return (
    <div className="min-h-screen bg-white p-4 flex flex-col gap-4 relative overflow-hidden">
      ...
      <div className="bg-white rounded-xl p-4 flex-1 relative z-10 ml-20">
        {showRecoveryAssist ? (
          <>
            {/* Recovery Assist Page */}
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-sm font-normal mb-4 mt-0">
              <button onClick={() => setShowRecoveryAssist(false)} className="text-slate-600 hover:text-slate-900 transition-colors font-normal">
                INC1789966
              </button>
              ...
              <ChevronRight className="w-4 h-4 text-slate-600" />
              <span className="text-slate-600">Recovery Assist</span>
            </div>
            ...
            <div className="flex gap-6 mb-4 border-b border-slate-200">
              ...
              >
                Summary
                {recoveryTab === 'summary' && <div className="absolute inset-x-0 -bottom-px h-0.5 bg-blue-600"></div>}
              </button>
              <button 
              ...
              >
                ...
                {recoveryTab === 'canvas' && <div className="absolute inset-x-0 -bottom-px h-0.5 bg-blue-600"></div>}
              </button>
            </div>
          ...
          <>
            ...
            <div className="flex justify-between items-center mb-4 mt-0">
              <div className="flex items-center gap-2 text-sm font-normal">
                ...
                <ChevronRight className="w-4 h-4 text-slate-600" />
                <span className="text-slate-600">{activeTab === 'overview' ? 'Overview' : 'Investigate'}</span>
              </div>
              <button 
                onClick={() => setShowRecoveryAssist(true)}
                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-3 py-1.5 rounded-lg flex items-center gap-2 shadow-xs transition-all text-xs"
              >
        ...
        <div className="flex gap-6 mb-4 border-b border-slate-200">
          ...
          >
            Overview
            {activeTab === 'overview' && <div className="absolute inset-x-0 -bottom-px h-0.5 bg-blue-600"></div>}
          </button>
          <button 
          ...
          >
            Investigate
            {activeTab === 'investigate' && <div className="absolute inset-x-0 -bottom-px h-0.5 bg-blue-600"></div>}
          </button>
        </div>
