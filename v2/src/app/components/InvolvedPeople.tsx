...
export function InvolvedPeople() {
  return (
    <div className="bg-white rounded-[10px] p-5 border border-slate-200 shadow-card">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-medium text-slate-900">Involved People</h3>
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  {idx === 0 && (
                    <span className="text-xs px-2 py-0.5 bg-red-100 text-red-700 rounded font-medium flex-shrink-0">
                      COMMANDER
                    </span>
                  )}
                </div>
