import { Clock, AlertTriangle, AlertCircle, CheckCircle, Activity, Users, Database, GitBranch, Terminal, Zap } from 'lucide-react';
...
export function IncidentTimeline() {
  return (
    <div className="bg-white rounded-xl pt-4 pr-4 pb-4 pl-5 w-full h-full flex flex-col shadow-[0_1px_8px_0_rgba(0,0,0,0.03)] border border-slate-200">
      ...
      <div className="space-y-4 relative flex-1 overflow-y-auto">
        ...
        <div className="absolute left-1 top-4 bottom-4 w-px bg-slate-200"></div>
        ...
        {timelineEvents.map((event, idx) => {
          ...
          return (
            <div key={idx} className="relative flex items-start gap-4">
              {/* Simple Dot */}
              <div className="w-2 h-2 rounded-full flex items-center justify-center flex-shrink-0 relative z-10 bg-slate-300" />
              ...
              <div className="flex-1 min-w-0 pb-4">
                ...
                <div className="text-sm font-medium text-slate-900 mb-1">{event.title}</div>
