import { TrendingUp, TrendingDown, AlertCircle, Clock, Users, Activity, DollarSign, ChevronDown, Server, ExternalLink, Share2, Search } from 'lucide-react';
...
export function ImpactMetricsCards({ onInvestigate }: ImpactMetricsCardsProps = {}) {
  ...
  const handleSeeAgentActivity = () => {
    // Highlight agent a4 (Log Analysis) for impact metrics
  ...
  const handleShareClick = () => {
    setShareContent({
      title: 'Impact Metrics Update',
      content: `Impact metrics for the last ${timeFrame}: ${currentMetrics.users.current} affected users, ${currentMetrics.requests.current} failed requests, ${currentMetrics.duration.current} duration.`
    });
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {/* Affected Users Card */}
        <div className="bg-white rounded-lg p-2.5 border border-slate-200 hover:border-slate-300 transition-all duration-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="mb-2">
              <div className="flex items-end gap-2">
                <div className="text-lg font-semibold text-slate-900">{currentMetrics.users.current}</div>
        ...
        <div className="bg-white rounded-lg p-2.5 border border-slate-200 hover:border-slate-300 transition-all duration-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="mb-2">
              <div className="flex items-end gap-2">
                <div className="text-lg font-semibold text-slate-900">{currentMetrics.requests.current}</div>
        ...
        <div className="bg-white rounded-lg p-2.5 border border-slate-200 hover:border-slate-300 transition-all duration-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="mb-2">
              <div className="flex items-center gap-2">
                <div className="text-lg font-semibold text-slate-900">{currentMetrics.duration.current}</div>
        ...
        <div className="bg-white rounded-lg p-2.5 border border-slate-200 hover:border-slate-300 transition-all duration-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="mb-2">
              <div className="flex items-end gap-2">
                <div className="text-lg font-semibold text-slate-900">{currentMetrics.revenue.current}</div>
        ...
        <div className="bg-white rounded-lg p-2.5 border border-slate-200 hover:border-slate-300 transition-all duration-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="mb-2">
              <div className="flex items-end gap-2">
                <div className="text-lg font-semibold text-slate-900">{currentMetrics.availability.current}</div>
        ...
        <div className="bg-white rounded-lg p-2.5 border border-slate-200 hover:border-slate-300 transition-all duration-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="mb-2">
              <div className="flex items-end gap-2">
                <div className="text-lg font-semibold text-slate-900">{currentMetrics.services.current}</div>
      ...
      <div className="mt-4 flex items-center gap-2 pt-4 border-t border-slate-200">
        ...
        <button 
          onClick={() => onInvestigate?.('Impact Metrics Investigation', `Impact metrics for the last ${timeFrame}: ${currentMetrics.users.current} affected users, ${currentMetrics.requests.current} failed requests, ${currentMetrics.duration.current} duration.`)}
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors border border-slate-200"
        >
